...
% compute the new Axx with a shift in time of half cycle
% first for the wave
...
% phase shift = shift / periods * 360 degrees
...
% figure;plot(AxxNoChange.wave(19,:));hold on; plot(shift.wave(19,:));plot(motion.wave(19,:));
