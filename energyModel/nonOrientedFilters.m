...
if dc==50
    ...
    plot(sum(energy_right-energy_left,2))
    legend('sum','diff')
    saveas(gcf,['NonOriented_StaticDetails' num2str(cycles) '.png'])
end
...
plot(sum(energy_right-energy_left,2))
legend('sum','diff')
    saveas(gcf,['NonOriented_MotionDetails' num2str(cycles) '.png'])
end
...
if mm==1
    saveas(gcf,'NonOriented_Static.png')
else
    saveas(gcf,'NonOriented_Moving.png')
end
